...
Abra el proyecto en [Android Studio](https://developer.android.com/studio). La version actual fue probada con Android Studio Otter 3 Feature Drop | 2025.2.3.9. Para generar el proyecto vaya a `Build` > `Build APKs`.
